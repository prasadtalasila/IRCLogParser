...
#     if [nick, channel[0], channel[1]] not in channel_user_edge_list:
#       channel_user_edge_list.append([nick, channel[0], channel[1]]) 
#     # print nick, channel[0], channel[1]
...
#  for i in channel_user_edge_list:
#   print str(nicks_hash.index(i[0]))+"\t"+str(1000000+channels_hash.index(i[1]))
...
#  print "========= CHANNEL HASH ========="
#  for i in range(len(channels_hash)):
#   print str(1000000+i)+"\t"+str(1)
...
#  # print nick_same_list
 ...
 #   # print nicks_hash.index(adjlist['nickname']),adjlist['nickname'], channels_hash.index(channel[0]),channel[0], channel[1]
 #   CU_adjacency_matrix[channels_hash.index(channel[0])][nicks_hash.index(adjlist['nickname'])] = channel[1]
 #   # myGraph.add_edge(adjlist['nickname'] ,channel[0], weight=channel[1])
 #   # if channel[1] > 25 :
 ...
 #   # print users_on_channel.keys()[i],users_on_channel.keys()[j]
 #   # channel_user_graph.add_edge(users_on_channel.keys()[i] ,users_on_channel.keys()[j], weight=len(common_users))
 ...
 #    # if not myGraph.has_edge(user1, user2):
 #     # myGraph.add_edge(user1 ,user2, weight=0)
 #     # myGraph.add_edge(user2 ,user1, weight=0)
     
 #    # myGraph[user1][user2]['weight'] += no_of_common_channels_day
 #    # myGraph[user2][user1]['weight'] += no_of_common_channels_day
