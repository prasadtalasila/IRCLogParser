...
def infomap_igraph(ig_graph, net_file_location=None, reduce_graph=False, pajek_type = None):
    """ 
    ...
    if reduce_graph:
        if (pajek_type == "UU"):
            ...
            ig_graph = select_top_vertices(ig_graph, "CC")
        else:
            ig_graph = select_top_vertices(ig_graph, "CU")
